...
const WORDS = ["AI & Data Science Student", "ML Developer", "LLM Engineer", "Tech Enthusiast"];
const TECH_STACK = ["Machine Learning", "Deep Learning", "Generative AI", "NLP"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/fazil6126912" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/mohammad-fazil-cheruvu-03ba55259/" },
  { icon: Instagram, link: "https://www.instagram.com/fazil5123?igsh=YjVuc3BweXY1M3Bk" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building Intelligent Systems and Data-Driven Solutions for Real-World Impact.
                </p>
